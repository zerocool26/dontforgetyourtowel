      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        <div className="space-y-4">
          ...
          <input
            ...
            onChange={event =>
              setCurrentMonthlyCost(Number(event.currentTarget.value))
            }
            type="number"
          ...
          <input
            ...
            onChange={event =>
              setEstimatedSavingsPct(Number(event.currentTarget.value))
            }
            type="number"
          ...
          <input
            ...
            onChange={event =>
              setOneTimeTransitionCost(Number(event.currentTarget.value))
            }
            type="number"
