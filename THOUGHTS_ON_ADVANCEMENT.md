...
-   **Rapier/Main Thread Physics**: Integrate a lightweight physics engine so when you scroll or touch, objects don't just move away, they *collide* and tumble.
...
## 6. Transitions
-   **Morph Targets**: Instead of fading out scene A and fading in scene B, *morph* the particles of scene A into the shape of scene B.
