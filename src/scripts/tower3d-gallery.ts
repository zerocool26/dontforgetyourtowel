...
const SCENE_NAMES = [
  ...
  'Volumetric Ink',
  'Cloth & Light',
  'Sculpted Point Cloud',
  'Fractal Finale',
  'Neural Constellation',
  'Library of Babel',
  'Bioluminescent Abyss',
  'Holographic Data City',
  'Reality Collapse',
];

// Scene descriptions for info tooltips
const SCENE_DESCRIPTIONS = [
  'A cinematic resonance chamber tuned to motion',
  'A living SDF relic morphing across materials',
  'Swarm intelligence in a luminous flow‑field',
  'Editorial letters assembling then shattering',
  'Dancing cosmic lights across the sky',
  'Gravitational lensing bends reality itself',
  'Technical wireframes pulsing with energy',
  'Ink clouds carving a hidden silhouette',
  'A colossal banner wrapping past the lens',
  'Scan‑grade points re‑lit in real time',
  'Infinite descent collapsing into a mark',
  'Neurons firing across a living constellation',
  'Infinite hex rooms of impossible knowledge',
  'Deep sea organisms painting darkness with light',
  'A cyberpunk city built from pure information',
  'All dimensions converge into singular truth',
];
