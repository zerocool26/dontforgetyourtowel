...
const mountCommandPalette = () => {
  ...
  dialogElement.setAttribute('aria-label', 'Command palette');
  ...
  searchInput.setAttribute('aria-controls', 'command-palette-listbox');
  searchInput.placeholder = 'Search commands';
  searchInput.autocomplete = 'off';

  const resultList = document.createElement('div');
  resultList.className = 'command-palette-list';
  resultList.id = 'command-palette-listbox';
  resultList.setAttribute('role', 'listbox');

  header.append(title, close);
  dialogElement.append(header, searchInput, resultList);
  backdrop.append(dialogElement);
  ...
  const dialogCard = dialogElement;
