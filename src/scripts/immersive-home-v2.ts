...
function mount(): void {
  ...
  const w = window as unknown as {
    __ihControllerV2?: ImmersiveThreeController;
  };

  if (w.__ihControllerV2) {
    w.__ihControllerV2.destroy();
    w.__ihControllerV2 = undefined;
  }

  w.__ihControllerV2 = new ImmersiveThreeController(root);
}
