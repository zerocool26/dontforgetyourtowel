  ...
  const staticPages = [
    {
      ...
      title: 'Home',
      description:
        'Design-forward MSP+ landing page for managed operations, security, cloud, AI, and premium digital proof',
      category: 'Page',
      url: '/',
      tags: ['home', 'landing', 'msp', 'security', 'cloud', 'ai'],
    },
    {
      id: 'page-company',
      title: 'Company',
      description:
        'Company story, buyer fit, delivery model, and how the MSP+ stack stays connected',
      category: 'Page',
      url: 'company/',
      tags: ['company', 'about', 'positioning', 'delivery model', 'msp'],
    },
    {
      id: 'page-gallery',
    ...
    },
    {
      ...
      title: 'Proof Lab',
      description:
        'Interactive proof lab with search, compare, cart persistence, and checkout simulation',
      category: 'Page',
      url: 'about/',
      tags: [
        'proof-lab',
    ...
    },
    {
      ...
      tags: ['proof-lab', 'shop-demo', 'checkout', 'launch'],
    },
    {
      id: 'page-services',
      title: 'Services',
      description:
        'Buyer-focused solution hub for managed operations, security, cloud, AI, and premium digital delivery',
      category: 'Page',
      url: 'services/',
