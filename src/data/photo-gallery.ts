...
export const photoGalleryItems: PhotoGalleryItem[] = [
  ...
  {
    id: 'commerce-review-room',
    title: 'Client-facing commerce review with stakeholders in mind',
    tag: 'Digital',
    collection: 'Commerce review',
    location: 'Demo showcase',
    format: 'Landscape hero',
    note: 'Works for ecommerce, portal, and intake storytelling where buyer trust and interface quality are the focus.',
    alt: 'Collaborative team meeting around laptops, representing a digital product and commerce review session.',
  ...
  },
  {
    ...
    alt: 'Design-focused workspace with screens and creative tools used as a premium digital build reference.',
